...
<body style="background-color: gray">
	...
	<div style="float: left; margin-left: 5%; width: 60%; height: 1500px">
		<div>
		...
		<div style="margin-left: 10%; margin-top: 5%;">
			<div>
				...
				<ol>
					...
					<div class="row">
						<h1>
							<li><%=studyListVo.getWord()%></li>
						</h1>
						<button class="btn-warning" style="margin-left: 5%; margin-bottom: 5%;">삭제</button>
					</div>
